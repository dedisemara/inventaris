...
<body id="home">
    ...
    <div class="container-fluid" style="margin-top: 5%;">
        <?php
        $temp = 'qualitycontrol/edit/' . $coba['id'];
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <?php if ($this->session->flashdata('error_sop')) : ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Perhatian </strong>Terdapat Format File yang Tidak Didukung/File Yang tidak di Edit!
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $coba['klasifikasi']; ?>" class="form-control" id="klasifikasi_e" name="klasifikasi_e">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="namaunit_e" class="col-sm-2 col-form-label">Nama Unit</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?= $coba['nama_alat']; ?>" class="form-control" id="namaunit_e" name="namaunit_e">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="kode_e" class="col-sm-2 col-form-label">Kode</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?= $coba['kode']; ?>" class="form-control" id="kode_e" name="kode_e">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="serialnumber_e" class="col-sm-2 col-form-label">Serial Number</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?= $coba['serial_number']; ?>" class="form-control" id="serialnumber_e" name="serialnumber_e">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="supplier_e" class="col-sm-2 col-form-label">Supplier</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?= $coba['supplier']; ?>" class="form-control" id="supplier_e" name="supplier_e">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tanggalmasuk_e" class="col-sm-2 col-form-label">Tanggal Masuk</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?= $coba['tanggal_masuk']; ?>" name="tanggalmasuk_e" class="form-control" id="date" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="kondisi_e" class="col-sm-2 col-form-label">Kondisi</label>
                            <div class="col-sm-10">
                                <select class="form-control" aria-placeholder="<?= $coba['kondisi']; ?>" id="kondisi_e" name="kondisi_e">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $coba['lokasi']; ?>" class="form-control" id="lokasi_e" name="lokasi_e">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fungsi_e" class="col-sm-2 col-form-label">Fungsi</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="3" name="fungsi_e" id="fungsi_e"><?= $coba['fungsi']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <input hidden type="text" value="<?= $coba['id']; ?>" class="form-control" id="id" name="id">
                    <!-- form 2 -->
                    <div class="col-lg-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="sop_e"><?= $coba['sop']; ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="manual_e"><?= $coba['manual']; ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="riwayat_e"><?= $coba['riwayat']; ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="sertif_e"><?= $coba['sertif_kalibrasi']; ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src="<?= base_url() ?>tambahan/img/<?= $coba['gambar']; ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="custom-file">
